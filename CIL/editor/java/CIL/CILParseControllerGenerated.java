...
public class CILParseControllerGenerated extends DynamicParseController 
{ 
  public static final String LANGUAGE = new String("CIL");
  ...
  { 
    CILParseControllerGenerated.descriptor = descriptor;
  }
  ...
  { 
    try
    { 
      InputStream descriptorStream = CILParseControllerGenerated.class.getResourceAsStream(DESCRIPTOR);
      InputStream table = CILParseControllerGenerated.class.getResourceAsStream(TABLE);
      ...
      descriptor.setAttachmentProvider(CILParseControllerGenerated.class);
    }
  ...
  { 
    return CILParseController.class.getProtectionDomain().getCodeSource().getLocation().getFile();
  }
