                    ...
                    if (cred_settings.use_ajax && cred_settings.use_ajax == 1) {
                        ...
                        $.ajax({
                            ...
                            success: function (data) {
                                ...
                                if (data) {
                                    //console.log(data);
                                    if( $( 'input[name="_cred_cred_prefix_form_id"]' ).val()!="6997" ){
                                    ...
                                    if( data.result == 'redirect' ){
                                        if( $( 'input[name="_cred_cred_prefix_form_id"]' ).val()=="6997" ){
                                                $( 'button.next' ).click();                                                                         $("input[name='_cred_cred_prefix_post_id'").val(parseInt($("input[name='_cred_cred_prefix_post_id'").val())+1);
